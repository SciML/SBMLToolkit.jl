...
COMP1 = SBML.Compartment("c1", true, 3, 2.0, "nl")
SPECIES1 = SBML.Species("s1", "c1", false, nothing, nothing, (1.0, "substance"), nothing, true)  # Todo: Maybe not support units in initial_concentration?
SPECIES2 = SBML.Species("s2", "c1", false, nothing, nothing, nothing, (1.0, "substance/nl"), false)
...
m = myread("data/00026-sbml-l3v2.xml")
sys = ODESystem(myread("data/00026-sbml-l3v2.xml"))
@test nothing !== sys.continuous_events
